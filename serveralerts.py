...
def create_db(DB_PATH):
    if os.path.isfile(DB_PATH):
        ...
        try:
            ...
            c.execute("INSERT INTO ZADALERTBUNDLE VALUES(1,2,2,1,1,1,'CertificateAlerts','Certificate')")
            c.execute("INSERT INTO ZADALERTBUNDLE VALUES(2,2,2,1,1,1,'Caching','Caching')")
            c.execute("INSERT INTO ZADALERTBUNDLE VALUES(3,2,2,1,1,1,'CalendarContactsAlerts','CalendarAndContacts')")
            c.execute("INSERT INTO ZADALERTBUNDLE VALUES(4,2,2,1,1,1,'Firewall','Firewall')")
            c.execute("INSERT INTO ZADALERTBUNDLE VALUES(5,2,2,1,1,1,'Mail','Mail')")
            c.execute("INSERT INTO ZADALERTBUNDLE VALUES(6,2,2,1,1,1,'TimeMachine','Time Machine')")
            c.execute("INSERT INTO ZADALERTBUNDLE VALUES(7,2,1,1,1,1,'Common','Common')")
            c.execute("INSERT INTO ZADALERTBUNDLE VALUES(8,2,2,1,1,1,'SoftwareUpdate','Software Update')")
            c.execute("INSERT INTO ZADALERTBUNDLE VALUES(9,2,2,1,1,1,'NetworkConfiguration','Network Configuration')")
            c.execute("INSERT INTO ZADALERTBUNDLE VALUES(10,2,2,1,1,1,'Xsan','Xsan')")
            c.execute("INSERT INTO ZADALERTBUNDLE VALUES(11,2,2,1,1,1,'XcodeServer','Xcode Server')")
            c.execute("INSERT INTO ZADALERTBUNDLE VALUES(12,2,2,1,1,1,'ProfileManager','Profile Manager')")
            c.execute("INSERT INTO ZADALERTBUNDLE VALUES(13,2,2,1,1,1,'Disk','Disk')")
